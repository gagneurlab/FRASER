...
#' @param addSpliceType Logical, indicating if the type of the splice event 
...
#' @describeIn spliceTypeAnnotations This method calculates basic annotations 
...
addSpliceTypeLabels <- function(junctions_dt, fds, txdb){
    ...
    junctions_dt[, spliceType := "complex"]
    ...
    junctions_dt[psi_positions[nones], spliceType := none_results[1,]]
    ...
    junctions_dt[thetas, spliceType := NA]
    ...
    junctions_dt[thetas[intronic], spliceType := "intronicRegion"]
...
checkExonSkipping <- function(junctions_dt, txdb){
    ...
    if(length(exonSkip) > 0){
        ...
        junctions_dt[spliceType2 == "splicingBeyondGene", 
                        spliceType := "splicingBeyondGene"]
        junctions_dt[spliceType2 == "splicingBeyondGene", 
                        causesFrameshift := "inconclusive"]
        junctions_dt[spliceType2 == "multigenicSplicing", 
                        spliceType := "multigenicSplicing"]
        junctions_dt[spliceType2 == "multigenicSplicing", 
                        causesFrameshift := "inconclusive"]
        junctions_dt[, spliceType2 := NULL]
    }
